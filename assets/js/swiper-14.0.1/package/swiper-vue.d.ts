...
declare const Swiper: DefineComponent<
   ...
   */
  virtualUpdate: (swiper: SwiperClass) => void;/**
   ...
   */
  setTranslate: (swiper: SwiperClass, translate: number, byController?: boolean | Swiper) => void;
   ...
   */
  setTransition: (swiper: SwiperClass, transition: number, byController?: boolean | Swiper) => void;
   ...
   */
  beforeTransitionStart: (swiper: SwiperClass, speed: number, internal: unknown) => void;
  /**
