// @ts-ignore
import { Swiper, SwiperOptions } from './types/public.js';
...
interface SwiperContainerEventMap extends Omit<HTMLElementEventMap, 'click' | 'progress' | 'keypress' | 'resize' | 'touchstart' | 'touchmove' | 'touchend' | 'transitionend' | 'transitionstart'> {
   ...
   */
  virtualupdate: CustomEvent<[swiper: Swiper]>;/**
   ...
   */
  settranslate: CustomEvent<[swiper: Swiper, translate: number, byController?: boolean | Swiper]>;
   ...
   */
  settransition: CustomEvent<[swiper: Swiper, transition: number, byController?: boolean | Swiper]>;
   ...
   */
  beforetransitionstart: CustomEvent<[swiper: Swiper, speed: number, internal: unknown]>;
  /**
