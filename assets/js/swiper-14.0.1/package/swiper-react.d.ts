...
import type { SwiperOptions, Swiper as SwiperClass } from './types/public.js';
...
> &
   ...
   */
  onVirtualUpdate?: (swiper: SwiperClass) => void;/**
   ...
   */
  onSetTranslate?: (swiper: SwiperClass, translate: number, byController?: boolean | Swiper) => void;
   ...
   */
  onSetTransition?: (swiper: SwiperClass, transition: number, byController?: boolean | Swiper) => void;
   ...
   */
  onBeforeTransitionStart?: (swiper: SwiperClass, speed: number, internal: unknown) => void;
  /**
