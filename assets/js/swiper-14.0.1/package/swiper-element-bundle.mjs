...
import { p as paramsList, n as needsNavigation, b as needsPagination, c as needsScrollbar, d as updateSwiper, a as attrToProp } from './shared/update-swiper.mjs';
...
class SwiperContainer extends ClassToExtend {
    ...
    calcSlideSlots() {
        ...
        const slideSlotChildren = [...this.querySelectorAll(`[slot^=slide-]`)].map((child) => parseInt(child.getAttribute('slot').split('slide-')[1], 10));
    ...
    connectedCallback() {
        const slideParent = this.closest('swiper-slide');
        if (this.swiper &&
