      ...
      <section class="chart-card">
        ...
        <div class="panel-toolbar">
          ...
          <div class="toolbar-right">
            <select class="filter-select" id="archiveFilter" aria-label="Show active or archived cards">
              <option value="active">Show: Active Cards</option>
              <option value="archived">Show: Archived Cards</option>
            </select>
