    ...
    <div class="container">
        ...
        <main class="main">
            ...
            <section class="procurement-cards">
                ...
                <div class="card-success card-clickable" id="successBuyCard" role="button" tabindex="0"
                    aria-pressed="false">
                    <div class="card-info">
            ...
            <section class="orders-card">
                <div class="orders-header">
                    ...
                    <div class="orders-actions">
                        <button type="button" class="modal-btn accept" id="addPurchasedCards">Add Purchased
                            Cards</button>
            ...
            <div class="admin-modal-overlay d-none" id="purchasedCardsModal" role="dialog" aria-modal="true"
                aria-labelledby="purchasedCardsTitle">
                <div class="admin-modal admin-modal-xl purchased-cards-modal">
                    <div class="admin-modal-header">
                        <h3 id="purchasedCardsTitle">Add Purchased Cards</h3><button type="button"
                            class="admin-modal-close" id="closePurchasedCardsModal">&times;</button>
                    </div>
                    <form class="admin-modal-body" id="purchasedCardsForm">
                        ...
                        <div class="modal-actions purchased-cards-actions">
                            <button type="button" class="modal-btn add" id="addAnotherPurchasedCard"><i
                                    class="fa-solid fa-plus"></i> Add Another Card</button>
                            <button type="submit" class="modal-btn accept" id="insertPurchasedCards">Insert
                                Card(s)</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="admin-modal-overlay d-none" id="lowStockModal" role="dialog" aria-modal="true"
                aria-labelledby="lowStockTitle">
                <div class="admin-modal admin-modal-xl procurement-low-stock-modal">
                    <div class="admin-modal-header">
                        <h3 id="lowStockTitle">Low Stock Resupply</h3><button type="button" class="admin-modal-close"
                            id="closeLowStockModal">&times;</button>
                    </div>
                    <div class="admin-modal-body">
                        <div class="procurement-supplier-row">
                            <label for="supplierSelect">Trusted supplier</label>
                            <select id="supplierSelect"></select>
                            <button type="button" class="modal-btn accept" id="placeProcurementOrder">Place
                                Order</button>
                        </div>
                        ...
                        <div class="procurement-table-wrap">
                            <table class="order-items-table procurement-items-table">
                                <colgroup>
                                    <col class="resupply-col">
                                    <col class="card-col">
                                    <col class="set-col">
                                    <col class="category-col">
                                    <col class="type-col">
                                    <col class="rarity-col">
            ...
            <div class="admin-modal-overlay d-none" id="procurementDetailsModal" role="dialog" aria-modal="true"
                aria-labelledby="procurementDetailsTitle">
                <div class="admin-modal admin-modal-xl">
                    <div class="admin-modal-header">
                        <h3 id="procurementDetailsTitle">Procurement Receipt</h3><button type="button"
                            class="admin-modal-close" id="closeProcurementDetailsModal">&times;</button>
                    </div>
                    <div class="admin-modal-body">
                        <div class="order-details-meta">
                            <div class="modal-detail-row"><span>Supplier</span><strong
                                    id="procurementSupplier">—</strong></div>
                            <div class="modal-detail-row"><span>Status</span><strong id="procurementStatus">—</strong>
                            </div>
                        ...
                        <div class="order-items-panel">
                            <table class="order-items-table">
                                ...
                                <tbody id="procurementDetailsItems"></tbody>
                            </table>
                        </div>
                        ...
                        <div class="procurement-status-update"><label for="procurementStatusSelect">Update
                                status</label><select id="procurementStatusSelect">
                                <option>Pending</option>
                                <option>Processing</option>
                                <option>In Transit</option>
                                <option>Delivered</option>
                                <option>Cancelled</option>
                            </select><button type="button" class="modal-btn accept"
                                id="updateProcurementStatus">Update</button></div>
