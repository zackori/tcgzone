...
$productsResult = mysqli_query($conn, "SELECT product_id, card_name, set_name, category, product_type, rarity, `condition`, stock_quantity, market_price FROM products WHERE stock_quantity <= 2 ORDER BY stock_quantity ASC, card_name ASC");
$products = [];
