...
<body>
  ...
  <main class="shop-page">
    <div class="container-fluid px-3 px-lg-0 py-4">
      ...
      <div class="results-bar px-5">
        ...
        <span class="results-count" id="resultsCount"><span class="results-count text-dark" id="resultsCount">0</span>
          Results Found</span>
      </div>
  ...
  <div class="modal fade product-modal" id="productModal" tabindex="-1" aria-labelledby="productModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <button type="button" class="btn-close btn-close-white modal-close-custom" data-bs-dismiss="modal"
  ...
  <!-- Shared JS for session validation -->
