...
form.addEventListener("submit", async function (e) {
  ...
  const displayRating = Math.min(selectedRating, 5);
  for (let i = 0; i < displayRating; i++) {
    starsHTML +=
      '<img src="/tcgzone/assets/logos/review/poke-open.svg" alt="star" class="review-star-icon">';
  }
