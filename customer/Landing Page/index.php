...
<body>
    ...
    <div class="container featured-card px-6 py-3">
        ...
        <button class="slider-arrow slider-arrow-left" type="button" data-slider="featured-track" data-dir="-1" aria-label="Scroll left">
        ...
        <div class="slider-track" id="featured-track">
            ...
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 3.png" alt="Image 3">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 2.png" alt="Image 2">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 4.png" alt="Image 4">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 6.png" alt="Image 6">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 7.png" alt="Image 7">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 8.png" alt="Image 8">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 9.png" alt="Image 9">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 10.png" alt="Image 10">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 11.png" alt="Image 11">
            </div>
            ...
            <article class="product-card">
            <div class="product-img-wrap">
                <img class="product-img" src="/tcgzone/assets/images/landing page/image 12.png" alt="Image 12">
            </div>
        ...
        <button class="slider-arrow slider-arrow-right" type="button" data-slider="featured-track" data-dir="1" aria-label="Scroll right">
...
<section class="section-block section-alt text-white">
    <div class="container">
        ...
        <div class="col-12 col-lg-6">
            ...
            <button class="slider-arrow slider-arrow-left" type="button" id="pack-prev" aria-label="Previous pack">
            ...
            <button class="slider-arrow slider-arrow-right" type="button" id="pack-next" aria-label="Next pack">
...
<section class="collection section-block">
    <div class="container">
        ...
        <button class="slider-arrow slider-arrow-left" type="button" data-slider="collections-track" data-dir="-1" aria-label="Scroll left">
            <img src="/tcgzone/assets/logos/upcoming packs/caret-left.svg" alt="Left">
        </button>

        <div class="slider-track" id="collections-track">
            <div class="collection-card">
                <img class="collection-img" src="/tcgzone/assets/images/landing page/image 18.png" alt="Collection 1">
            </div>
            <div class="collection-card">
                <img class="collection-img" src="/tcgzone/assets/images/landing page/image  19.png" alt="Collection 2">
            </div>
            <div class="collection-card">
                <img class="collection-img" src="/tcgzone/assets/images/landing page/image 20.jpg"alt="Collection 3">
            </div>
            <div class="collection-card">
                <img class="collection-img" src="/tcgzone/assets/images/landing page/image 21.png" alt="Collection 4">
            </div>
            <div class="collection-card">
                <img class="collection-img" src="/tcgzone/assets/images/landing page/image 22.png" alt="Collection 4">
            </div>
        </div>

        <button class="slider-arrow slider-arrow-right" type="button" data-slider="collections-track" data-dir="1" aria-label="Scroll right">
            <img src="/tcgzone/assets/logos/upcoming packs/caret-right.svg" alt="Right">
        </button>
        </div>
